    ...
    <div class="absolute bg-gray-800 rounded-2xl shadow-2xl overflow-hidden"
      ...
      <div class="flex items-center justify-between p-6 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-600">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h2 class="text-xl font-semibold text-white">Professional Assistant</h2>
            <p class="text-sm text-gray-400">AI Content Creator</p>
          </div>
        </div>
        <div class="flex items-center space-x-3">
          ...
          <button class="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600">
