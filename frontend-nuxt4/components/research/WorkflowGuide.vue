    ...
    <div v-if="!currentTemplate" class="space-y-3">
      ...
      <div class="grid grid-cols-1 gap-2">
        <button
          ...
          class="flex items-center space-x-3 p-3 bg-gray-900/80 backdrop-blur-sm border-2 border-gray-600/70 shadow-lg rounded-lg hover:bg-gray-600 transition-colors text-left"
        >
