...
# Stable Server Script for CreatorMate
# This script ensures the server stays running reliably

echo "🚀 Starting CreatorMate Stable Server..."
...
cd /Users/darrenberich/CreatorMate
...
if curl -s http://localhost:8888/health > /dev/null 2>&1; then
    ...
    echo "📋 Logs: tail -f /Users/darrenberich/CreatorMate/server.log"
else
