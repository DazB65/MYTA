      ...
      <div className="flex-1 bg-gray-100 p-8 overflow-y-auto">
        ...
        <div className="bg-white rounded-xl p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Create plan and create your content</p>
          </div>
          ...
          <div className="flex items-center space-x-4 mb-8">
            <div className="flex items-center space-x-2">
              ...
              <button className="bg-gray-100 text-gray-600 px-4 py-2 rounded-lg text-sm hover:bg-gray-200">
                📚 Scripts
              </button>
              <button className="bg-gray-100 text-gray-600 px-4 py-2 rounded-lg text-sm hover:bg-gray-200">
                🖼️ Thumbnails
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border shadow-sm">
                  ...
                  <button className="w-full bg-pink-500 text-white py-2 rounded-lg text-sm font-medium hover:bg-pink-600">
                    Publish Now
                  </button>
                </div>
