#!/bin/bash
# Vidalytics Development Docker Script
...
start_services() {
    log_info "Starting Vidalytics development services..."
...
stop_services() {
    log_info "Stopping Vidalytics development services..."
    docker compose -f $COMPOSE_FILE -p $PROJECT_NAME down
    log_success "Services stopped successfully!"
}

restart_services() {
    log_info "Restarting Vidalytics development services..."
    stop_services
    start_services
}
...
build_services() {
    log_info "Building Vidalytics development services..."
...
clean_up() {
    log_info "Cleaning up Vidalytics development environment..."
    ...
    docker images --format "table {{.Repository}}:{{.Tag}}\t{{.ID}}" | grep Vidalytics | awk '{print $2}' | xargs -r docker rmi -f
...
show_help() {
    echo "Vidalytics Development Docker Script"
    echo ""
